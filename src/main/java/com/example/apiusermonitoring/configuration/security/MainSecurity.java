...
import com.example.apiusermonitoring.configuration.security.jwt.JwtEntryPoint;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                .authorizeRequests(requests -> requests
                        ...
                        .requestMatchers("/api-test/users/**", "/api-test/user-monitoring").hasAnyAuthority(USER_ROLE, ADMIN_ROLE)
